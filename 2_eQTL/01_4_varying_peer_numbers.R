# 01_4_varying_peer_numbers.R

################################################################################

# 1.4. Compare eQTL results after including increasing number of PEER factors in the model

################################################################################

# Aim: Decide n peer factors to include in main effects eQTL model 

########################### Output paths ##########################

########################### Input paths ###########################
# path to input files
inpath <- "genotyping/analysis/eQTL/output_data/peer_test_results/"
...
# visualize (Supplementary Figure 31)
gridExtra::grid.arrange(p1, p2, nrow=1)

# I am going with 30 PEER factors